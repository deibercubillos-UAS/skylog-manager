...
| 31 | **`32-migracion.md` escrito** | Reglas de precedencia sobre los conflictos ya medidos (§16.4 de `20-auditoria-datos.md`): bajo riesgo se resuelve solo, alto riesgo (clase ③ vigente) nunca en silencio — bloquea el corte de esa organización hasta que su administrador confirme | [`32`](32-migracion.md) |
