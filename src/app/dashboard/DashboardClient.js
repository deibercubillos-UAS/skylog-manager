...
export default function DashboardClient({ initialData }) {
    // Usamos los datos inyectados desde el servidor (Paso 2)
    const [data] = useState(initialData);

    // LÓGICA DE ESCALADO MATEMÁTICO (Tu lógica original)
                ...
                <div className="lg:col-span-2 bg-white p-6 md:p-10 rounded-[2.5rem] border border-slate-200 shadow-sm flex flex-col h-[380px] md:h-[450px]">
                    <div className="flex justify-between items-start mb-10">
                        <div>
                            ...
                            <span className="text-[9px] font-black bg-emerald-50 px-2 py-1 rounded text-emerald-600 uppercase mt-2 inline-block">Sincronización GPS On</span>
                        </div>
                    </div>
