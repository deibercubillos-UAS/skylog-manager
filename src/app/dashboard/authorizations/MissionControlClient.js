        ...
        <div className="space-y-10 pb-20 animate-in fade-in duration-700 text-left">
            ...
            <div className="flex bg-slate-100 p-1.5 rounded-2xl w-fit">
                <button 
                    ...
                    className={`px-8 py-2.5 rounded-xl text-xs font-black uppercase transition-all ${activeTab === 'basica' ? 'bg-white text-orange-600 shadow-sm' : 'text-slate-500'}`}
                >
                    Misión Básica
                </button>
                <button 
                    onClick={() => setActiveTab('aerocivil')}
                    className={`px-8 py-2.5 rounded-xl text-xs font-black uppercase transition-all ${activeTab === 'aerocivil' ? 'bg-white text-orange-600 shadow-sm' : 'text-slate-500'}`}
                >
            ...
            <section className="bg-white rounded-[2.5rem] border border-slate-200 shadow-sm overflow-hidden">
                ...
                {loadingMissions ? (
                    <div className="p-20 text-center text-slate-400 font-black text-xs uppercase tracking-widest animate-pulse">
