        ...
        <div className="max-w-7xl mx-auto space-y-8 text-left pb-32 animate-in fade-in duration-500">
            ...
            {activeTab === 'aerocivil' && (
                <div className="space-y-10 animate-in slide-in-from-right duration-500">
                    ...
                    {/* REEMPLAZO DE UBICACIÓN EN SECCIÓN 4 */}
                    <div className="p-8 space-y-4">
                        ...
                        {/* FILA DE SELECTORES GEOGRÁFICOS */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                            <div className="space-y-1">
                                <label className="text-[9px] font-black uppercase text-slate-400 ml-1">Departamento</label>
                                <select 
                                    className="w-full p-3 bg-slate-50 rounded-xl border-none font-bold text-xs focus:ring-2 focus:ring-orange-500 outline-none"
                            ...
                            <div className="space-y-1">
                                ...
                                <select 
                                    ...
                                    className="w-full p-3 bg-slate-50 rounded-xl border-none font-bold text-xs focus:ring-2 focus:ring-orange-500 outline-none disabled:opacity-50"
