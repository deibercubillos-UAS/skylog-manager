  ...
  return (
    <div className="h-[calc(100vh-4rem)] flex flex-col items-center justify-center bg-slate-950 animate-in fade-in duration-500">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="text-slate-500 text-xs">Visualización de traza DJI .txt · Procesado en el navegador</p>
      </div>
      ...
      {state !== 'loading' && (
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-slate-500 mt-1">Arrastra o haz clic · archivo .txt</p>
          </div>
