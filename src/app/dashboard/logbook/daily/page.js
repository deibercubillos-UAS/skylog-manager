    ...
    return (
        <div className="max-w-4xl mx-auto space-y-10 text-left">
            <header className="flex justify-between items-center border-b pb-4">
                ...
                <span className="bg-orange-100 text-orange-600 px-4 py-1 rounded-full text-xs font-black">F-OPS-001</span>
            </header>

            <section className="bg-orange-50 p-8 rounded-[2.5rem] border border-orange-200">
                <h3 className="text-xs font-black text-orange-600 uppercase mb-4 tracking-widest">Órdenes de Vuelo Programadas</h3>
                ...
                <p className="text-xs text-orange-400 mt-3 italic font-bold">Selecciona una misión para cargar los datos técnicos automáticamente.</p>
            </section>
