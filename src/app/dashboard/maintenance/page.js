    ...
    return (
        <div className="space-y-10 text-left animate-in fade-in duration-700 pb-20">
            <header className="flex justify-between items-end border-b pb-6">
                ...
                {canManage && (
                    <button onClick={() => setShowAdd(true)} className="bg-orange-600 text-white px-8 py-3 rounded-xl font-black text-xs uppercase shadow-lg hover:bg-slate-900 transition-all">+ Nueva Intervención</button>
                )}
            </header>
