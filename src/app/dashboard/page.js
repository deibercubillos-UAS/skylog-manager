            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-white p-6 md:p-10 rounded-[2.5rem] border border-slate-200 shadow-sm flex flex-col h-[380px] md:h-[450px]">
                    <div className="flex justify-between items-start mb-10">
                        <h3 className="text-[10px] font-black uppercase text-slate-400 tracking-[0.3em]">Actividad Operativa</h3>
                        <span className="text-[9px] font-black bg-emerald-50 px-2 py-1 rounded text-emerald-600">AUTO-SCALE ON</span>
                    </div>
