...
function PaymentForm() {
    ...
    const handleCardNumberChange = (e) => {
        ...
        let formattedValue = value.match(/.{1,4}/g)?.join(' ') || value; // Agrega espacio cada 4
        setCardNumber(formattedValue.substring(0, 19)); // Límite de 16 dígitos + 3 espacios
    };
    ...
    const handlePayment = async (e) => {
        ...
        // Referencia directa al formulario para evitar error 101
            ...
            <form onSubmit={handlePayment} id="epayco-form" className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" data-epayco="card[cvc]" maxLength="4" required placeholder="***" className="w-full p-4 bg-white border border-slate-200 rounded-2xl text-center font-black" />
                    </div>
                </div>
...
export default function TokenPayPage() {
  return (
    <main className="min-h-screen bg-[#f8f6f6] flex flex-col lg:flex-row font-display">
      ...
      <section className="flex-1 p-8 md:p-20 flex flex-col ju