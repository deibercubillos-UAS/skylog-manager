...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Plataforma para operadores ESUAS. 5 roles RAC 100, todos los módulos, acceso sin costo en Fase 0/Fase I de certificación (máx. 6 meses).',
...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "¿Bitafly ayuda durante el proceso de certificación ESUAS?", "acceptedAnswer": { "@type": "Answer", "text": "Sí. Si tu empresa está en Fase 0 o Fase I del proceso de certificación como Explotador UAS ante la AeroCivil, Bitafly te da acceso sin costo durante esa etapa, hasta un máximo de 6 meses. Contáctanos con tu número de radicado para activarlo." } },
  ],
};
      ...
      <section style={{padding:'80px 32px 72px',background:'#fff',position:'relative',overflow:'hidden',isolation:'isolate'}}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2" style={{maxWidth:'1100px',margin:'0 auto',gap:'56px',alignItems:'center'}}>
          <div>
            ...
            <p style={{fontSize:'11px',fontWeight:700,color:'#94a3b8',marginTop:'14px'}}>Sin costo en Fase 0/Fase I de certificación (máx. 6 meses) · Sin tarjeta de crédito</p>
          </div>
          <DroneOpsScene />
        </div>
      </section>
      ...
      <section style={{padding:'80px 32px',background:'#fff'}}>
        <div className="grid grid-cols-1 lg:grid-cols-2" style={{maxWidth:'1100px',margin:'0 auto',gap:'56px',alignItems:'center'}}>
          ...
          <div style={{background:'#1A202C',borderRadius:'32px',padding:'40px',display:'flex',flexDirection:'column',gap:'20px'}}>
            <div style={{fontSize:'10px',fontWeight:900,textTransform:'uppercase',letterSpacing:'0.3em',color:accent}}>Fase 0 y Fase I · Proceso de certificación</div>
            ...
            <p style={{fontSize:'13px',color:'#94a3b8',lineHeight:1.7}}>Si estás en Fase 0 o Fase I del proceso, accede a Bitafly <strong style={{color:'#fff'}}>sin costo</strong> durante esa etapa, hasta un máximo de 6 meses. Contáctanos con tu número de radicado.</p>
