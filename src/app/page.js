          ...
          <section id="precios" className="py-24 px-6 bg-[#f8f6f6]">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16 space-y-4">
                ...
                <p className="text-slate-500 max-w-2xl mx-auto">
                  Empieza gratis. Actualiza cuando agregues más drones, tripulantes o
                  necesites el SMS empresarial. Sin contratos rígidos.
                </p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                {/* PILOTO */}
                <article className="bg-white p-8 rounded-3xl border border-slate-200 flex flex-col">
                  <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">
                    Piloto
                  </h3>
                  <p className="text-4xl font-black text-navy">Gratis</p>
                  <p className="text-xs text-slate-500 mt-1">Para operadores individuales</p>
                  <ul className="space-y-2 mt-6 text-sm text-slate-700 flex-1">
                  ...
                  <Link
                    href="/registro"
                    className="mt-8 text-center bg-slate-100 text-navy py-3 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-slate-200 transition-all"
                  >
                    Comenzar gratis
                  </Link>
                </article>
                ...
                {/* OPERADOR — destacado */}
                <article className="bg-navy text-white p-8 rounded-3xl border-2 border-primary flex flex-col relative shadow-2xl scale-105">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-primary text-white text-[9px] font-black uppercase tracking-widest px-4 py-1 rounded-full">
                    Más popular
                  </div>
                  ...
                  <p className="text-xs text-slate-400 mt-1">
                    Para empresas con flota completa
                  </p>
                  <ul className="space-y-2 mt-6 text-sm text-slate-300 flex-1">
                    <li className="flex gap-2">
                      <span className="material-symbols-outlined text-primary text-sm">
                        check
                      </span>{' '}
                    ...
                    <li className="flex gap-2">
                      ...
                      Tripulación multi-rol
                    </li>
                    <li className="flex gap-2">
                      <span className="material-symbols-outlined text-primary text-sm">
                        check
                      </span>{' '}
                      SMS aeronáutico completo
                    </li>
                    <li className="flex gap-2">
                      <span className="material-symbols-outlined text-primary text-sm">
                        check
                      </span>{' '}
                      Autorizaciones AeroCivil
                    </li>
                    <li className="flex gap-2">
                      <span className="material-symbols-outlined text-primary text-sm">
                        check
                  ...
                  <Link
                    href="/registro"
                    className="mt-8 text-center bg-primary text-white py-3 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-orange-600 transition-all"
                  >
                    Solicitar demo
                  </Link>
                </article>
                ...
                <article className="bg-white p-8 rounded-3xl border border-slate-200 flex flex-col">
                  ...
                  <p className="text-4xl font-black text-navy">Custom</p>
                  <p className="text-xs text-slate-500 mt-1">
                    Operadores con múltiples bases
                  </p>
                  <ul className="space-y-2 mt-6 text-sm text-slate-700 flex-1">
                    <li className="flex gap-2">
                      <span className="material-symbols-outlined text-primary text-sm">
