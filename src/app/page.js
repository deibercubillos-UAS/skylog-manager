      ...
      <section className="py-20 bg-white dark:bg-background-dark border-y border-slate-200 dark:border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-xl border border-slate-200 dark:border-slate-800 bg-background-light dark:bg-slate-900/50">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm">Stay fully compliant with current RAC aeronautical regulations automatically.</p>
            </div>
            <div className="p-8 rounded-xl border border-slate-200 dark:border-slate-800 bg-background-light dark:bg-slate-900/50">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm">Conduct thorough SORA risk assessments for every flight operation.</p>
            </div>
            <div className="p-8 rounded-xl border border-slate-200 dark:border-slate-800 bg-background-light dark:bg-slate-900/50">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm">Receive automated alerts for scheduled drone maintenance.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white dark:bg-slate-800 p-8 rounded-xl border border-slate-200 dark:border-slate-700">
              ...
              <button className="w-full py-3 rounded-lg border border-primary text-primary font-bold">Empezar Gratis</button>
            </div>
            {/* Pro */}
            <div className="bg-white dark:bg-slate-800 p-8 rounded-xl border-2 border-primary relative shadow-2xl scale-105 z-10">
              ...
              <button className="w-full py-3 rounded-lg bg-primary text-white font-bold shadow-lg shadow-primary/30">Probar 14 días</button>
            </div>
            {/* Custom */}
            <div className="bg-white dark:bg-slate-800 p-8 rounded-xl border border-slate-200 dark:border-slate-700">
              <h3 className="text-lg font-bold mb-2">Plan Enterprise</h3>
              <div className="text-4xl font-black mb-4">Custom</div>
              <button className="w-full py-3 rounded-lg bg-navy text-white font-bold">Contact Sales</button>
            </div>
          </div>
        </div>
      </section>
