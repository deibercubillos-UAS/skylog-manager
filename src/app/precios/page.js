...
export const metadata = {
  ...
  description: 'Bitafly desde el Plan Piloto hasta Enterprise. Plan Piloto con 15 días de prueba, Escuadrilla $200.000/mes + IVA, Flota $400.000/mes + IVA. Sin contratos. Cumplimiento RAC 100 incluido. Paga con PSE o tarjeta.',
  ...
  openGraph: {
    ...
    description: 'Desde el Plan Piloto hasta Enterprise. Planes que crecen con tu flota. Sin contratos rígidos.',
...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "¿Hay descuento por pago anual en Bitafly?", "acceptedAnswer": { "@type": "Answer", "text": "Sí. El pago anual tiene un descuento del 10%. El plan Escuadrilla pasa de $200.000/mes a $180.000/mes (equivalente, + IVA). El plan Flota pasa de $400.000/mes a $360.000/mes (equivalente, + IVA)." } },
  ...
  "offers": [
    {
      "@type": "Offer",
      "name": "Plan Piloto",
      "description": "Para operadores individuales. 1 aeronave, bitácora ilimitada, reportes PDF. 15 días de prueba al iniciar.",
      "price": "20000",
      "priceCurrency": "COP",
