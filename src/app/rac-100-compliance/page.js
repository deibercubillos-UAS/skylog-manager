...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'What official documents does AeroCivil require?', acceptedAnswer: { '@type': 'Answer', text: 'AeroCivil requires: F-OPS-002 (Flight Master Log — one per flight), F-MNT-003 (Battery Maintenance Record), F-HUM-005 (Pilot Flight Hours Record), and F-OPS-001 (Flight Authorization Request for special operations). Bitafly generates all four automatically in PDF.' } },
...
const REQUIREMENTS = [
  ...
  { title: 'Flight Logbook (F-OPS-002)', desc: 'Every commercial flight must be logged in the official AeroCivil format, including aircraft, pilot, mission, battery status and flight hours.' },
  { title: 'Battery Records (F-MNT-003)','desc': 'Each battery must be tracked by serial number with cycle counts and maintenance interventions documented in the F-MNT-003 format.' },
