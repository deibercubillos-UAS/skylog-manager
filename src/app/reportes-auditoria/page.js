...
export const metadata = {
  ...
  openGraph: {
    title: 'Reportes Oficiales AeroCivil para Drones — F-OPS-002, F-MNT-003, F-HUM-005 | Bitafly',
    description: 'Genera todos los formatos oficiales exigidos por la UAEAC en PDF en menos de 5 segundos. Logo corporativo, código de formato y versión.',
...
const faqSchema = {
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "¿Qué reportes genera Bitafly para la AeroCivil?", "acceptedAnswer": { "@type": "Answer", "text": "Bitafly genera 4 reportes oficiales: F-OPS-002 Maestro de Vuelo, F-MNT-003 Registro de Baterías, F-HUM-005 Bitácora de Piloto y F-OPS-001 Solicitud de Autorización de Vuelo. Todos en PDF con logo corporativo, código de formato y versión." } },
    { "@type": "Question", "name": "¿Los reportes de Bitafly son aceptados por los inspectores de la AeroCivil?", "acceptedAnswer": { "@type": "Answer", "text": "Sí. Los formatos generados por Bitafly incluyen todos los campos exigidos por la UAEAC, con el código de formato oficial, versión, logo corporativo y firma. Están diseñados para ser presentados directamente en inspecciones de la AeroCivil." } },
  ...
  return (
    <>
        ...
        <div style={{maxWidth:'1100px',margin:'0 auto',display:'grid',gridTemplateColumns:'1fr 1fr',gap:'56px',alignItems:'center'}}>
          <div>
            ...
            <p style={{fontSize:'16px',fontWeight:500,color:'#64748b',lineHeight:1.65,maxWidth:'480px',marginBottom:'28px'}}>
              Exporta los formatos oficiales exigidos por la UAEAC con logo corporativo, código de formato y versión. Auditorías sin sorpresas, inspecciones sin papeles perdidos.
            </p>
            ...
            <p style={{fontSize:'11px',fontWeight:700,color:'#94a3b8',marginTop:'14px'}}>PDF en segundos · Logo corporativo · Código de formato oficial</p>
          </div>
          {/* PDF mockup */}
      ...
      <section style={{background:'#f8f6f6',padding:'80px 32px'}}>
        <div style={{maxWidth:'760px',margin:'0 auto'}}>
          <div style={{textAlign:'center',marginBottom:'48px'}}>
            ...
            <h2 style={{fontSize:'clamp(28px,3vw,44px)',fontWeight:900,textTransform:'uppercase',letterSpacing:'-0.04em',color:'#1A202C'}}>Todo sobre los <span style={{color:accent}}>formatos oficiales</span></h2>
          </div>
      ...
      <div style={{background:'#1A202C',padding:'80px 32px',textAlign:'center'}}>
        ...
        <p style={{fontSize:'15px',color:'#94a3b8',maxWidth:'560px',margin:'0 auto 32px'}}>Todos los formatos oficiales de la AeroCivil generados automáticamente desde tus datos de operación.</p>
      ...
      <SEOFooter brandDesc="Reportes oficiales AeroCivil para operadores UAS en Colombia. F-OPS-002, F-MNT-003, F-HUM-005." />
    </>
  );
}
