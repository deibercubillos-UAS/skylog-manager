    ...
    <aside className="fixed z-[150] bg-white flex flex-col text-left
      ...
      <div className="flex-1 overflow-y-auto p-6 md:p-8 custom-scrollbar">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button disabled={loading} className="w-full py-4 bg-slate-900 text-white font-black rounded-xl uppercase text-xs shadow-lg mt-2 disabled:opacity-60 active:scale-95 transition-all">
