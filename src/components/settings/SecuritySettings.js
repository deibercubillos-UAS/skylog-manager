  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300 text-left">
      <div className="border-b border-slate-100 pb-4">
        ...
        <p className="text-xs text-slate-400 font-medium mt-1">Protege tus credenciales y el acceso a la bitácora.</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-[1.5rem] p-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-start gap-4">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-slate-500 font-medium leading-tight max-w-xs mt-1">
        ...
        <div className="p-6 border border-slate-100 rounded-[1.5rem] flex items-center justify-between">
           <div className="text-left">
             ...
             <p className="text-xs text-slate-400">Activa en este navegador</p>
           </div>
           <span className="px-3 py-1 bg-emerald-100 text-emerald-600 text-xs font-black rounded-full uppercase">En Línea</span>
        </div>
